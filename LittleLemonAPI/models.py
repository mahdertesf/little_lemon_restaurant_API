...
class Category(models.Model):
    ...
    title=models.CharField(max_length=255, dp_index=True)

class MenuItems(models.Model):
    title=models.CharField(max_length=255, db_index=True)
    price=models.DecimalField(max_digits=6,decimal_palces=2,db_index=True)
...
class Order(models.Model):
    ...
    total=DecimalField(max_digits=6,decimal_palces=2)
